            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-body p-0">
                        <div id="filterCard">
                            <div class="p-3">
                                <form id="roleSearchForm" action="{{ route('admin.roles.index') }}" method="GET" class="row g-3">
                                    <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        <h4 class="header-title">Roles Management</h4>
                        <div class="d-flex gap-2">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="downloadDropdown">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.roles.export', array_merge(request()->query(), ['type' => 'excel'])) }}">
                                            <i class="fas fa-file-excel me-2"></i> Export to Excel
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.roles.export', array_merge(request()->query(), ['type' => 'csv'])) }}">
                    ...
                    <table id="roles-datatable" class="table table-striped dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>
                                    <a href="{{ route('admin.roles.index', array_merge(request()->query(), ['sort_by' => 'id', 'order' => request('order') == 'asc' ? 'desc' : 'asc'])) }}" class="text-dark">
                                        ID
                                ...
                                <th>
                                    <a href="{{ route('admin.roles.index', array_merge(request()->query(), ['sort_by' => 'name', 'order' => request('order') == 'asc' ? 'desc' : 'asc'])) }}" class="text-dark">
                                        Name
                                ...
                                <th>
                                    <a href="{{ route('admin.roles.index', array_merge(request()->query(), ['sort_by' => 'created_at', 'order' => request('order') == 'asc' ? 'desc' : 'asc'])) }}" class="text-dark">
                                        Created At
                        ...
                        <tbody>
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.roles.assignPermissions', $role->id) }}" class="btn btn-success btn-sm" title="Assign Rights">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="text-muted">
                            Showing {{ $roles->firstItem() ?? 0 }} to {{ $roles->lastItem() ?? 0 }} of {{ $roles->total() ?? 0 }} entries
                        </div>
                        <div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#roleSearchForm').on('submit', function(e) {
            e.preventDefault();
            $(this).submit();
        });
