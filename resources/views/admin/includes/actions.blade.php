<div class="flex gap-4 items-center module-action">
    ...
    <a href="{{ route($currentRoute.'.edit',$row->id) }}" class="hover:text-info">
    ...
    <a data-id="{{ $row->id }}" href="{{ route($currentRoute.'.destroy', $row->id) }}" class="hover:text-info btn-delete-record">
